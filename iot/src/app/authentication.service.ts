...
onLoginGeneralDashboard(account:any){
  ...
  return this.http.get(`http://4.188.244.11/userside_graph_view/${account}/`)
}
...
//   return this.http.get<any>(`http://4.188.244.11/account_view/${accountno}/`)
// }


accountClickedMessage(accountno:any){
  console.log("account",accountno);
  return this.http.get<any>(`http://4.188.244.11/userside_account_view/${accountno}/`)
}

onAllDeviceslist(user:any){
  console.log("username",user);
  return this.http.get<any>(`http://4.188.244.11/userside_device_view/${user}/`)
  }

...
addRegisterDevice(deviceDetails:any){
  ...
  return this.http.post<any>('http://20.244.51.20:8000/device_create/', deviceDetails)
...
onLoginGeneralDashboard(account:any){
  ...
  return this.http.get(`http://20.244.51.20:8000/userside_graph_view/${account}/`)
}
...
onAdmincreateuserpond(pondDetails:any){
  return this.http.post<any>('http://20.244.51.20:8000/account/',pondDetails)
}

accountClickedMessage(accountno:any){
  console.log("account",accountno);
  return this.http.get<any>(`http://20.244.51.20:8000/account_view/${accountno}/`)
}

onAllDeviceslist(user:any){
  console.log("username",user);
  return this.http.get<any>(`http://20.244.51.20:8000/userside_device_view/${user}/`)
  }
}
